...
public class PlayerControllerAux : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        if (isLocal)
        {
            ...
            if (Input.GetKeyDown(KeyCode.P) && inventoryManager.pocionesDisponibles())
            {
                // Nos curamos
                playerCombat.restoreHealth(inventoryManager.getPotionRestoration());

                // Consumimos una pocion
                inventoryManager.delPocion();
            }
